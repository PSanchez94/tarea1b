...
if __name__ == "__main__":
    ...
    trees = sg.SceneGraphNode("Forest")
    ...
    main_scene_translate.childs += [sky] + [forest] + [trees]
    ...
    while not glfw.window_should_close(window):
        ...
        sky.transform = tr.translate(0.0, scene_movement * 0.3, 0)
        forest.transform = tr.translate(0.0, scene_movement * 0.6, 0)
        trees.transform = tr.translate(0.0, scene_movement * 0.1, 0)
